...
data?: any;
    ...
    <div className="flex justify-between flex-wrap gap-4">
        ...
        <InputField label="كلمة العبور" name="password" type="password" defaultValue={data?.password} register={register} error={errors?.password}/>
    </div>
        <span className="text-xs text-gray-400 font-medium">Personnel Information</span>
    <div className="flex justify-between flex-wrap gap-4">
